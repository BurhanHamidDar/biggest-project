            ...
            if (loginType === 'password') {
                ...
                if (!otpSent) {
                    ...
                    if (error) {
                        ...
                        if (signupError) {
                            console.error('All verification attempts failed:', signupError);
                            throw signupError; // Throw the original or signup error
                        }
                    }
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.contentContainer}>
                ...
                <Text style={styles.appName}>Students App</Text>
